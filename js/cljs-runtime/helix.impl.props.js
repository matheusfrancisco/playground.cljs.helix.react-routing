...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21810_SHARP_,p2__21809_SHARP_){
return p2__21809_SHARP_.toUpperCase();
}));
...
var G__21819 = o;
helix.impl.props.goog$module$goog$object.set(G__21819,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21911 = cljs.core.rest(m);
var G__21912 = (function (){var entry = cljs.core.first(m);
...
var G__21834 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21834,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21868_SHARP_){
if(cljs.core.map_QMARK_(p1__21868_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21868_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__21914 = cljs.core.rest(m);
var G__21915 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__21920 = cljs.core.rest(m);
var G__21921 = (function (){var entry = cljs.core.first(m);
