...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21847_SHARP_,p2__21846_SHARP_){
return p2__21846_SHARP_.toUpperCase();
}));
...
var G__21860 = o;
helix.impl.props.goog$module$goog$object.set(G__21860,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21939 = cljs.core.rest(m);
var G__21940 = (function (){var entry = cljs.core.first(m);
...
var G__21873 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21873,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21910_SHARP_){
if(cljs.core.map_QMARK_(p1__21910_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21910_SHARP_);
} else {
return p1__21910_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__21946 = cljs.core.rest(m);
var G__21947 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__21950 = cljs.core.rest(m);
var G__21951 = (function (){var entry = cljs.core.first(m);
