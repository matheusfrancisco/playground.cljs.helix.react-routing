...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21742_SHARP_,p2__21741_SHARP_){
return p2__21741_SHARP_.toUpperCase();
}));
...
var G__21746 = o;
helix.impl.props.goog$module$goog$object.set(G__21746,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21799 = cljs.core.rest(m);
var G__21800 = (function (){var entry = cljs.core.first(m);
...
var G__21776 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21776,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21778_SHARP_){
if(cljs.core.map_QMARK_(p1__21778_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21778_SHARP_);
} else {
return p1__21778_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__21804 = cljs.core.rest(m);
var G__21805 = (function (){var entry = cljs.core.first(m);
