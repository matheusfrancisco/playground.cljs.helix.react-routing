...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21787_SHARP_,p2__21786_SHARP_){
return p2__21786_SHARP_.toUpperCase();
}));
...
var G__21792 = o;
helix.impl.props.goog$module$goog$object.set(G__21792,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21885 = cljs.core.rest(m);
var G__21886 = (function (){var entry = cljs.core.first(m);
...
var G__21821 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21821,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21830_SHARP_){
if(cljs.core.map_QMARK_(p1__21830_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21830_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__21894 = cljs.core.rest(m);
var G__21895 = (function (){var entry = cljs.core.first(m);
