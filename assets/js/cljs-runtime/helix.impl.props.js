...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21698_SHARP_,p2__21697_SHARP_){
return p2__21697_SHARP_.toUpperCase();
}));
...
var G__21699 = o;
helix.impl.props.goog$module$goog$object.set(G__21699,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21742 = cljs.core.rest(m);
var G__21743 = (function (){var entry = cljs.core.first(m);
...
var G__21702 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21702,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21710_SHARP_){
if(cljs.core.map_QMARK_(p1__21710_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21710_SHARP_);
} else {
return p1__21710_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__21746 = cljs.core.rest(m);
var G__21747 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__21751 = cljs.core.rest(m);
var G__21752 = (function (){var entry = cljs.core.first(m);
