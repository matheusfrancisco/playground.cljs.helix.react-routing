...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__21777_SHARP_,p2__21776_SHARP_){
return p2__21776_SHARP_.toUpperCase();
}));
...
var G__21781 = o;
helix.impl.props.goog$module$goog$object.set(G__21781,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__21817 = cljs.core.rest(m);
var G__21818 = (function (){var entry = cljs.core.first(m);
...
var G__21791 = o1;
helix.impl.props.goog$module$goog$object.extend(G__21791,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21792_SHARP_){
if(cljs.core.map_QMARK_(p1__21792_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__21792_SHARP_);
} else {
return p1__21792_SHARP_;
}
}),style));
} else {
return style;
